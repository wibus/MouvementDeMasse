...
SET(MOUVEMENT_DE_MASSE_SRC_FILES
    ...
    ${MOUVEMENT_DE_MASSE_CONFIG_FILES})
    

# Visual Studio filters
SOURCE_GROUP("Header Files" FILES ${MOUVEMENT_DE_MASSE_HEADERS})
SOURCE_GROUP("Header Files\\Algorithm" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_HEADERS})
SOURCE_GROUP("Header Files\\Algorithm\\Citizen" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_CITIZEN_HEADERS})
SOURCE_GROUP("Header Files\\Algorithm\\Height" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_HEIGHT_HEADERS})
SOURCE_GROUP("Header Files\\Algorithm\\Kruskal" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_KRUSKAL_HEADERS})
SOURCE_GROUP("Header Files\\Algorithm\\Map Element" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_MAP_ELEMENT_HEADERS})
SOURCE_GROUP("Header Files\\City" FILES ${MOUVEMENT_DE_MASSE_CITY_HEADERS})
SOURCE_GROUP("Header Files\\Rendering" FILES ${MOUVEMENT_DE_MASSE_RENDERING_HEADERS})

SOURCE_GROUP("Source Files" FILES ${MOUVEMENT_DE_MASSE_SOURCES})
SOURCE_GROUP("Source Files\\Algorithm" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_SOURCES})
SOURCE_GROUP("Source Files\\Algorithm\\Citizen" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_CITIZEN_SOURCES})
SOURCE_GROUP("Source Files\\Algorithm\\Height" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_HEIGHT_SOURCES})
SOURCE_GROUP("Source Files\\Algorithm\\Kruskal" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_KRUSKAL_SOURCES})
SOURCE_GROUP("Source Files\\Algorithm\\Map Element" FILES ${MOUVEMENT_DE_MASSE_ALGORITHM_MAP_ELEMENT_SOURCES})
SOURCE_GROUP("Source Files\\City" FILES ${MOUVEMENT_DE_MASSE_CITY_SOURCES})
SOURCE_GROUP("Source Files\\Rendering" FILES ${MOUVEMENT_DE_MASSE_RENDERING_SOURCES})

SOURCE_GROUP("Config" FILES ${MOUVEMENT_DE_MASSE_CONFIG_FILES})
